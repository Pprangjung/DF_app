...
SWIFT_CLASS("_TtC6DF_app11AppDelegate")
...
SWIFT_CLASS("_TtC6DF_app20LogChangePController")
@interface LogChangePController : UIViewController
- (void)viewDidLoad;
...
SWIFT_CLASS("_TtC6DF_app15LoginController")
@interface LoginController : UIViewController
@property (nonatomic, readonly, strong) UIView * _Nonnull inputsContainerView;
@property (nonatomic, strong) UIButton * _Nonnull loginSignUp;
- (void)handleSignup;
...
@property (nonatomic, readonly, strong) UIButton * _Nonnull loginRegisSegment;
- (void)handleLoginchangepageWithSender:(UIButton * _Nonnull)sender;
- (void)viewDidLoad;
- (void)setupLoginBut;
...
@interface LoginController (SWIFT_EXTENSION(DF_app)) <UIImagePickerControllerDelegate, UINavigationControllerDelegate>
- (void)handleRegister;
- (void)handleProfile;
...
@interface UIColor (SWIFT_EXTENSION(DF_app))
- (nonnull instancetype)initWithR:(CGFloat)r g:(CGFloat)g b:(CGFloat)b;
@end


SWIFT_CLASS("_TtC6DF_app14ViewController")
